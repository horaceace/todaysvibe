...
// Titles: curated complete phrases (readable, shareable, intentional)
// Plus descriptions, colors, emojis — all date-seeded
// ============================================================

// Complete vibe titles — each reads as a full "today's identity", not random word mash
const VIBE_TITLES = [
  // Main-character / confidence
  "Main Character Energy",
  "Soft Launch Confidence",
  "Quiet Power Move",
  "Unbothered Mode",
  "Plot Armor On",
  "Boss Level Calm",
  ...
  "Unhinged but Soft",
  "Chaos With a Plan",
  "Sparking Wire Energy",
  "Reckless Optimism",
  "Delightfully Unstable",
  "Storm in a Teacup",
  "Glitter Panic Mode",
  "Loud Heart, Soft Hands",
  "Messy and Magnetic",
  "Voltage Overload",
  "Fun Crisis Energy",
  ...
  "Reply When Ready",
  "Soft Extrovert",
  "Introvert Battery Full",
  "Circle Small, Love Big",
  "Seen and Soft",
  "Low Stakes Social",
  "Favorite Person Energy",
  "Kind Eyes On",
  "No Forced Plans",
  ...
  // Creative
  "Idea Weather Clear",
  "Sketch First Mentality",
  "Make Ugly Things",
  "First Draft Courage",
  "Color Outside Softly",
  "Muse On Call",
  "Play Before Perfect",
  "Collage Brain Active",
  "Creative Side Quest",
  "Weird Idea Welcome",
  "Studio Day Energy",
  "Doodle Through It",
  ...
  // Mood / existential light
  "Bittersweet Clear",
  "Nostalgia Lite",
  "Existential Soft",
  "Grateful and Tired",
  "Hope With Disclaimers",
  "Melancholy Sparkle",
  "Oddly Okay Today",
  "Emotionally Online",
  ...
  "Permission Granted",
  "Unapologetic Soft",
  "Crown Slightly Tilted",
  "Icon Behavior Lite",
  "Drama-Free Fame",
  "Legendary Errands",
  "Mythic Grocery Run",

  // Playful / gen-z adjacent (readable, not random mash)
  "Delulu But Hydrated",
  "Brat Mode Soft",
  "Rizz Is Kindness",
  "No Cap Clarity",
  ...
  "Side Character Peace",
  "Plot Twist: You're Fine",

  // Nature / elemental as full phrase
  "After the Storm Soft",
  "Sun Through Clouds",
  "Tide Coming In",
  "Wind at Your Back",
  "Roots Before Wings",
...
// Legacy pools kept for optional experiments / future tools
const ADJECTIVES = [
  // Cosmic / Celestial (30)
...
// Light oracle lines — playful, not life advice
const DO_LIST = [
  "text the person you keep rewriting the message to",
  "take the longer walk on purpose",
  "start the draft, even badly",
  "wear the thing you save for later",
  "say the honest version first",
  "put your phone in another room for 20 minutes",
  "order the slightly nicer option",
  "send the meme that is actually a feeling",
  "open one tab only",
  "make the playlist for tonight-you",
  "ask for the thing without a 3-paragraph apology",
  "stretch before you spiral",
  "leave 10 minutes early",
  "drink water like it’s a plot point",
  "compliment something specific",
  "close two loops you’ve been carrying",
  "sit by a window for no reason",
  "write three ugly bullet points",
  "say no once without explaining",
  "buy the flowers for your desk",
  "call instead of stacking voice notes",
  "move your body until the static clears",
  "let a message sit unanswered for an hour",
  "wear soft clothes on hard tasks",
  "make the bed as a tiny win",
  "pick the quieter café",
  "tell someone what you’re proud of",
  "delete one app you’ll reinstall next week",
  "read one page of something paper",
  "go outside before the algorithm does"
];

const DONT_LIST = [
  "reread the old chat for evidence",
  "start a group project in the group chat",
  "caffeine as a personality",
  "explain your whole personality in one text",
  "open LinkedIn for a ‘quick look’",
  "agree to plans you already dread",
  "doomscroll as a bedtime story",
  "negotiate your worth in your head only",
  "reply all when reply is fine",
  "romanticize the almost",
  "skip lunch for productivity cosplay",
  "pick a fight with the mirror",
  "buy chaos in checkout",
  "promise tomorrow what today can’t hold",
  "refresh for validation",
  "over-explain a soft boundary",
  "compare your Tuesday to their highlight reel",
  "turn a feeling into a spreadsheet",
  "leave the hard email for 11:58pm",
  "perform being fine",
  "stack five shows ‘for background’",
  "borrow stress from next week",
  "make your soft day prove itself",
  "text-and-walk into traffic energy",
  "keep the tab of the thing you’re avoiding",
  "audit your face in group photos",
  "say ‘it’s fine’ when it isn’t",
  "start a new habit empire at midnight",
  "let one notification own the hour",
  "shrink so the room stays comfortable"
];
